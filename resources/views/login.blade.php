...
<main class="form-signin w-100 m-auto text-center border bg-body-tertiary" style="border-radius: 10px">
  <img class="mb-4" src="img/logo.png" alt="" width="auto" height="100" >

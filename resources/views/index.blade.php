    ...
    <section class="hero" id="home">
      <main>
        <div class="content">
          ...
          <p>MINIMAL PEMESANAN 12,6 KUBIK KIRIMAN LANGSUNG PABRIK</p>
          <P>GRADE A</P>
          <P>KAMI DISTRIBUTOR BATARINGAN UNTUK MELAYANI WILAYAH JAWA BARAT</P>
          <P>BEKASI CIKARANG CIBITUNG KARAWANG </P>
          <h3>085797845026</h3>
        </div>
      </main>
    </section>
